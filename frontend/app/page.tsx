...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-white overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-[-10%] left-[-10%] h-87.5 sm:h-125 w-87.5 sm:w-125 rounded-full bg-blue-50/50 blur-3xl" />
      <div className="absolute right-[-5%] top-[20%] h-75 sm:h-100 w-75 sm:w-100 rounded-full bg-violet-50/50 blur-3xl" />
      ...
      <main className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center px-6 py-16 md:py-20 lg:py-24 text-center md:px-12 lg:px-24">
        ...
        <div className="mt-10 sm:mt-12 md:mt-14 flex flex-col gap-3 sm:gap-4 sm:flex-row">
          ...
          <Link href="/postjob" className="flex items-center justify-center rounded-2xl border-2 border-gray-200 bg-white px-8 py-3.5 sm:py-4 text-base sm:text-lg font-bold text-gray-700 shadow-sm hover:border-gray-300 hover:bg-gray-50 hover:shadow-md transition-all active:scale-95">
            Post a Job
          </Link>
        </div>
